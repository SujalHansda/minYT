...
//triggers whenever the page changes
window.onload = init();
...
function replaceHomePage() {
  //setting display to block and !important to override youtube's inline style
  ...
  if (window.location.pathname === "/") {
    ...
    input.addEventListener("keypress", function (e) {
      if (e.key === "Enter") {
        ...
        //sets and automatically navigates to the url.[property of windows.location.href when set to a new url]
      }
    });
